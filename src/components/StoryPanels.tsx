      ...
      >
        ...
        <div className="flex justify-center">
          <div className={`w-60 sm:w-72 lg:w-80 rounded-[40px] overflow-hidden border-2 phone-bleed ${isDark ? 'border-white/10' : 'border-black/10'}`}>
            <img src={isDark ? img_write_questions : img_write_questions_light} alt="Writing your three questions" className="w-full block" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="panel px-5 sm:px-8 overflow-hidden">
      ...
      >
        ...
        <div className="flex justify-center">
          {custom ?? (
            <div className={`w-60 sm:w-72 lg:w-80 rounded-[40px] overflow-hidden border-2 phone-bleed ${isDark ? 'border-white/10' : 'border-black/10'}`}>
              <img src={isDark ? imageDark : imageLight} alt={alt} className="w-full block" loading="lazy" />
            </div>
          )}
        </div>
      </div>
