        ...
        <div ref={cardRef} className="opacity-0 translate-y-8 transition-all duration-700">
          <div className="relative rounded-2xl border border-mint/20 bg-white/60 dark:bg-mint/[0.03] backdrop-blur-sm p-6 sm:p-8 overflow-hidden">
            ...
            <div className="relative">
              ...
              <a
                href="#download"
                className="hidden lg:inline-flex mt-6 sm:mt-8 w-full items-center justify-center px-6 py-3.5 rounded-full bg-mint text-gray-900 font-syne font-bold text-sm active:scale-95 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-mint/30 transition-all duration-200"
              >
                Download
              </a>
            </div>
