...
/**
 * The original poster hero: one full screen of typography, no product.
 * Kept as the control arm for the hero A/B — see HERO in routes/home.tsx.
 */
    ...
    <section className="panel items-center text-center px-5 sm:px-8 pt-20 pb-10">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-2xl leading-relaxed mb-10 max-w-xl mx-auto">
          There's more to someone than a picture. Discover how they think, what
          matters to them, and if there's something worth exploring — before you connect.
        </p>
