/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46574ae2dae5ea429ae13e4874e94826)
// Runtime types generated with workerd@1.20260721.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	VITE_EMAILJS_SERVICE_ID: string;
	VITE_EMAILJS_TEMPLATE_ID: string;
	VITE_EMAILJS_PUBLIC_KEY: string;
	VITE_EMAILJS_WAITLIST_TEMPLATE_ID: string;
	VITE_ANDROID_BETA_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_EMAILJS_SERVICE_ID" | "VITE_EMAILJS_TEMPLATE_ID" | "VITE_EMAILJS_PUBLIC_KEY" | "VITE_EMAILJS_WAITLIST_TEMPLATE_ID" | "VITE_ANDROID_BETA_URL">> {}
}
